...
func HTML(c *gin.Context, storage StorageOperations) {
...
func Get(c *gin.Context, storage StorageOperations) {
...
func Update(c *gin.Context, storage StorageOperations) {
	metricType := c.Param("type")
	if metricType == "gauge" {
